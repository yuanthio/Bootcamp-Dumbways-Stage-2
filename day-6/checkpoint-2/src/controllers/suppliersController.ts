...
export const login = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const token = jwt.sign(
      { id: supplier.id, email: supplier.email },
...
export const getMyProducts = async (
  req: Request & { supplier?: { id: number } },
  res: Response
) => {
  try {
...
export const getMySensitiveInfo = async (
  req: Request & { supplier?: { id: number } },
  res: Response
) => {
  try {
    ...
    const decrypted = supplier.sensitiveInfo
      ? decrypt(supplier.sensitiveInfo)
      : null;
